...
const Header = () => {
  return (
    <header
      className='sticky top-0 flex items-center justify-between space-x-2 font-bold px-10 py-5 
      border-b-4 border-[#52daf2]/50 backdrop-blur-3xl drop-shadow-md rounded z-10'>
